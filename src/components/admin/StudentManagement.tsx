...
export default function StudentManagement() {
  ...
  const testDatabaseConnection = async () => {
    try {
      console.log('Testing database connection for students...')
      ...
      // Test if we can access the students table and see its structure
      ...
      if (data && data.length > 0) {
        console.log('Students table structure (sample row):', data[0])
      ...
      if (error) {
        ...
        console.error('1. The students table does not exist')
  ...
  const fetchData = async () => {
    try {
      setLoading(true)
      console.log('Fetching students, classes, and parents from database...')
      ...
      console.log('Parents response:', { data: parentsData, error: parentsError })
      ...
      if (studentsError) {
        ...
        console.log('Students fetched successfully:', studentsData)
      ...
      if (parentsError) {
        ...
        console.log('Parents fetched successfully:', parentsData)
      ...
      <CardHeader>
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription>
              Manage all students in the system ({students.length} students)
            </CardDescription>
          </div>
